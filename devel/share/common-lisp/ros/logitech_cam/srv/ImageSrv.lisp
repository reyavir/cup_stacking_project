...
(cl:in-package logitech_cam-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <ImageSrv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ImageSrv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name logitech_cam-srv:<ImageSrv-request> is deprecated: use logitech_cam-srv:ImageSrv-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ImageSrv-request>)))
  ...
  (cl:format cl:nil "# An empty request~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ImageSrv-request)))
  "Returns full string definition for message of type 'ImageSrv-request"
  (cl:format cl:nil "# An empty request~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <ImageSrv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ImageSrv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name logitech_cam-srv:<ImageSrv-response> is deprecated: use logitech_cam-srv:ImageSrv-response instead.")))

(cl:ensure-generic-function 'image_data-val :lambda-list '(m))
(cl:defmethod image_data-val ((m <ImageSrv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader logitech_cam-srv:image_data-val is deprecated.  Use logitech_cam-srv:image_data instead.")
  (image_data m))
